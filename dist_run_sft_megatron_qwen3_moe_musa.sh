...
(( GLOBAL_BATCH_SIZE = $MICRO_BATCH_SIZE * $NUM_MICROBATCHES * $DP_SIZE * $EP_SIZE ))
echo "GLOBAL_BATCH_SIZE: $GLOBAL_BATCH_SIZE"

set -u
  WORK_HOME="$PWD"
  PATCH_HOME="$PWD"/../..
  EXPNAME="qwen3_30b_a3b_sft_tp${TP_SIZE}_pp${PP_SIZE}_ep${EP_SIZE}_dp${DP_SIZE}_mbs${MICRO_BATCH_SIZE}_numbs${NUM_MICROBATCHES}_gbs${GLOBAL_BATCH_SIZE}_gpus${WORLD_SIZE}"
