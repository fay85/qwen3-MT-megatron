#!/bin/bash
# Qwen3-8B SFT on 8 MUSA GPUs (Megatron-Core + TransformerEngine FP8).
#
# HF reference: Qwen/Qwen3-8B
#   hidden_size=4096, num_layers=36, num_heads=32, num_kv_heads=8,
#   head_dim=128 (requires --kv-channels 128), intermediate_size=12288,
...
# Qwen3-8B: head_dim=128 differs from hidden_size/num_heads=128,
